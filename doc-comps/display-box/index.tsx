...
import Editor from 'react-simple-code-editor';  // 代码展示区域
import CopyToClipboard from 'react-copy-to-clipboard'; // 复制代码
import { useToggle } from 'react-use';  // react hook
import ReactTooltip from 'react-tooltip';
import IconCopy from 'react-feather/dist/icons/clipboard';
import IconCode from 'react-feather/dist/icons/code';
import { highlight, languages } from 'prismjs/components/prism-core'; // 代码高亮
...
export const DisplayBox: React.FC<Props> = ({ code, title, desc, children }) => {
